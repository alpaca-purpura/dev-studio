...
/** Historias de EJEMPLO del overlay Backlog (spec shell §3.4, RN-7): el board real llega con
 *  el port de Historia/Capability (PB-07). El modo picker SÍ es real — elegir una de estas
 *  liga la sesión nueva a su historia. */
export interface MockStory {
  id: string;
  titulo: string;
  estado: StoryState;
  rol: string | null;
  tipo: "ui" | "tech" | "service" | "func";
  release: "F1" | "F2";
  capability: string;
...
export const MOCK_BACKLOG: MockStory[] = [
  { id: "hx-panorama", titulo: "Panorama transversal de sesiones entre repositorios", estado: "idea", rol: null, tipo: "func", release: "F2", capability: "multi-repositorio", prioridad: "media" },
  { id: "hx-changelog", titulo: "Publicar changelog automático por capability", estado: "idea", rol: null, tipo: "tech", release: "F2", capability: "backlog-historias", prioridad: "baja" },
  { id: "hx-board", titulo: "Tablero backlog con los estados del proceso", estado: "refining", rol: "PO", tipo: "ui", release: "F1", capability: "backlog-historias", prioridad: "alta" },
  { id: "hx-checkpoints", titulo: "Checkpoints y revert por turno de conversación", estado: "refined", rol: null, tipo: "ui", release: "F2", capability: "sesiones-multiples", prioridad: "media" },
  { id: "hx-diff-conv", titulo: "Diff conversacional: comentar una línea y que el rol la resuelva", estado: "ready", rol: null, tipo: "ui", release: "F2", capability: "revision-cambios", prioridad: "media" },
  { id: "hx-worktree", titulo: "Aislar sesión en workspace propio (PB-02)", estado: "developing", rol: "FS", tipo: "tech", release: "F1", capability: "sesiones-multiples", prioridad: "crítica" },
  { id: "hx-sse-retry", titulo: "Resolver reconexión SSE con retry", estado: "developing", rol: "BE", tipo: "tech", release: "F1", capability: "sesiones-multiples", prioridad: "alta" },
  { id: "hx-watcher", titulo: "Watcher de build para Vite (mantenimiento)", estado: "developed", rol: "DO", tipo: "tech", release: "F1", capability: "comandos-dev", prioridad: "baja" },
  { id: "hx-rutas", titulo: "Validar rutas protegidas por sesión", estado: "reviewing", rol: "QA", tipo: "tech", release: "F1", capability: "sesiones-multiples", prioridad: "crítica" },
  { id: "hx-roster", titulo: "Vista Roles conectada al registry (PB-06)", estado: "reviewing", rol: "AR", tipo: "ui", release: "F2", capability: "roles-roster", prioridad: "media" },
  { id: "hx-rail", titulo: "Rail de sesiones colapsable (F1)", estado: "done", rol: "FS", tipo: "ui", release: "F1", capability: "sesiones-multiples", prioridad: "media" },
  { id: "hx-pausada", titulo: "Compañero móvil (fuera de alcance por ahora)", estado: "parked", rol: null, tipo: "func", release: "F2", capability: "multi-repositorio", prioridad: "baja" },
  { id: "hx-dropped", titulo: "Torre de control transversal (eliminada del shell, §0.5)", estado: "dropped", rol: null, tipo: "ui", release: "F2", capability: "multi-repositorio", prioridad: "baja" },
];
